package com.projectdelta.habbit.ui.edit
...
import com.projectdelta.habbit.ui.edit.activity.state.CollapsingToolbarState
import com.projectdelta.habbit.ui.edit.activity.state.EditTaskInteractionManager
import com.projectdelta.habbit.ui.edit.activity.state.EditTaskInteractionState
...
class EditTaskViewModel @Inject constructor(
	...
	private val editTaskInteractionManager: EditTaskInteractionManager =
		EditTaskInteractionManager()
	...
	fun isToolbarCollapsed() =
		collapsingToolbarState.toString() == CollapsingToolbarState.STATE_COLLAPSED

	@Suppress("unused")
	fun isToolbarExpanded() =
		collapsingToolbarState.toString() == CollapsingToolbarState.STATE_EXPANDED
